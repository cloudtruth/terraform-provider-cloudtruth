...
func testAccResourceAWSPushActionBasic(resource, name, intID, desc string, params, secrets, templates, coerce, force, local bool, region, service, resourcePattern string) string {
	return fmt.Sprintf(`
	...
	`, resource, name, intID, desc, params, secrets, templates, coerce, force, local, region, service, resourcePattern)
}
