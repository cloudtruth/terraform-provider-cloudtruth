...
// checks if the PaginatedAwsIntegrationList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedAwsIntegrationList{}
...
func (o PaginatedAwsIntegrationList) ToMap() (map[string]interface{}, error) {
