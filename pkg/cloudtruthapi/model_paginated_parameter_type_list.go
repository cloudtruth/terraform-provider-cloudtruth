...
// checks if the PaginatedParameterTypeList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedParameterTypeList{}
...
func (o PaginatedParameterTypeList) ToMap() (map[string]interface{}, error) {
