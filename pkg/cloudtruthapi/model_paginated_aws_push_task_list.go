...
// checks if the PaginatedAwsPushTaskList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedAwsPushTaskList{}
...
func (o PaginatedAwsPushTaskList) ToMap() (map[string]interface{}, error) {
