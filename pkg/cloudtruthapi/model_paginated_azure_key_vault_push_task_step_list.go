...
func NewPaginatedAzureKeyVaultPushTaskStepList() *PaginatedAzureKeyVaultPushTaskStepList {
	this := PaginatedAzureKeyVaultPushTaskStepList{}
	return &this
}
...
// SetResults gets a reference to the given []AzureKeyVaultPushTaskStep and assigns it to the Results field.
...
type NullablePaginatedAzureKeyVaultPushTaskStepList struct {
	value *PaginatedAzureKeyVaultPushTaskStepList
	isSet bool
}

func (v NullablePaginatedAzureKeyVaultPushTaskStepList) Get() *PaginatedAzureKeyVaultPushTaskStepList {
	return v.value
}

func (v *NullablePaginatedAzureKeyVaultPushTaskStepList) Set(val *PaginatedAzureKeyVaultPushTaskStepList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedAzureKeyVaultPushTaskStepList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedAzureKeyVaultPushTaskStepList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedAzureKeyVaultPushTaskStepList(val *PaginatedAzureKeyVaultPushTaskStepList) *NullablePaginatedAzureKeyVaultPushTaskStepList {
	return &NullablePaginatedAzureKeyVaultPushTaskStepList{value: val, isSet: true}
}

func (v NullablePaginatedAzureKeyVaultPushTaskStepList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedAzureKeyVaultPushTaskStepList) UnmarshalJSON(src []byte) error {
	v.isSet = true
