...
type _AzureKeyVaultPullTask AzureKeyVaultPullTask
...
func (o *AzureKeyVaultPullTask) UnmarshalJSON(bytes []byte) (err error) {
	...
	varAzureKeyVaultPullTask := _AzureKeyVaultPullTask{}

	err = json.Unmarshal(bytes, &varAzureKeyVaultPullTask)

	if err != nil {
		return err
	}

	*o = AzureKeyVaultPullTask(varAzureKeyVaultPullTask)
