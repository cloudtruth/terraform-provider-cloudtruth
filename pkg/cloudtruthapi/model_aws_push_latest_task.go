...
// checks if the AwsPushLatestTask type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsPushLatestTask{}
...
type _AwsPushLatestTask AwsPushLatestTask
...
func (o AwsPushLatestTask) ToMap() (map[string]interface{}, error) {
...
func (o *AwsPushLatestTask) UnmarshalJSON(bytes []byte) (err error) {
	...
	varAwsPushLatestTask := _AwsPushLatestTask{}

	err = json.Unmarshal(bytes, &varAwsPushLatestTask)

	if err != nil {
		return err
	}

	*o = AwsPushLatestTask(varAwsPushLatestTask)
