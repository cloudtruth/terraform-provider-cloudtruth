...
var _ MappedNullable = &AwsPushTaskStep{}

// AwsPushTaskStep Push task step for an AWS integration.
type AwsPushTaskStep struct {
	Url string `json:"url"`
...
func (o AwsPushTaskStep) ToMap() (map[string]interface{}, error) {
...
type NullableAwsPushTaskStep struct {
	value *AwsPushTaskStep
	isSet bool
}

func (v NullableAwsPushTaskStep) Get() *AwsPushTaskStep {
	return v.value
}

func (v *NullableAwsPushTaskStep) Set(val *AwsPushTaskStep) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsPushTaskStep) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsPushTaskStep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsPushTaskStep(val *AwsPushTaskStep) *NullableAwsPushTaskStep {
	return &NullableAwsPushTaskStep{value: val, isSet: true}
}

func (v NullableAwsPushTaskStep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsPushTaskStep) UnmarshalJSON(src []byte) error {
	v.isSet = true
