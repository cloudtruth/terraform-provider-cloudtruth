...
// checks if the AwsPullTask type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsPullTask{}
...
func (o AwsPullTask) ToMap() (map[string]interface{}, error) {
...
func (o *AwsPullTask) UnmarshalJSON(bytes []byte) (err error) {
	...
	varAwsPullTask := _AwsPullTask{}

	err = json.Unmarshal(bytes, &varAwsPullTask)

	if err != nil {
		return err
	}

	*o = AwsPullTask(varAwsPullTask)
