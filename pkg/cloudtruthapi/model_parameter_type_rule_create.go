...
type _ParameterTypeRuleCreate ParameterTypeRuleCreate
...
func (o *ParameterTypeRuleCreate) UnmarshalJSON(bytes []byte) (err error) {
	...
	varParameterTypeRuleCreate := _ParameterTypeRuleCreate{}

	err = json.Unmarshal(bytes, &varParameterTypeRuleCreate)

	if err != nil {
		return err
	}

	*o = ParameterTypeRuleCreate(varParameterTypeRuleCreate)
