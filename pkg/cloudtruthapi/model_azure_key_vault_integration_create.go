...
type _AzureKeyVaultIntegrationCreate AzureKeyVaultIntegrationCreate
...
func (o *AzureKeyVaultIntegrationCreate) UnmarshalJSON(bytes []byte) (err error) {
	...
	varAzureKeyVaultIntegrationCreate := _AzureKeyVaultIntegrationCreate{}

	err = json.Unmarshal(bytes, &varAzureKeyVaultIntegrationCreate)

	if err != nil {
		return err
	}

	*o = AzureKeyVaultIntegrationCreate(varAzureKeyVaultIntegrationCreate)
