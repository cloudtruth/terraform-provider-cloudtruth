...
// checks if the PaginatedAzureKeyVaultPushList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedAzureKeyVaultPushList{}
...
func NewPaginatedAzureKeyVaultPushList() *PaginatedAzureKeyVaultPushList {
	this := PaginatedAzureKeyVaultPushList{}
	return &this
}
...
// SetResults gets a reference to the given []AzureKeyVaultPush and assigns it to the Results field.
func (o *PaginatedAzureKeyVaultPushList) SetResults(v []AzureKeyVaultPush) {
	o.Results = v
}

func (o PaginatedAzureKeyVaultPushList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedAzureKeyVaultPushList) ToMap() (map[string]interface{}, error) {
...
type NullablePaginatedAzureKeyVaultPushList struct {
	value *PaginatedAzureKeyVaultPushList
	isSet bool
}

func (v NullablePaginatedAzureKeyVaultPushList) Get() *PaginatedAzureKeyVaultPushList {
	return v.value
}

func (v *NullablePaginatedAzureKeyVaultPushList) Set(val *PaginatedAzureKeyVaultPushList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedAzureKeyVaultPushList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedAzureKeyVaultPushList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedAzureKeyVaultPushList(val *PaginatedAzureKeyVaultPushList) *NullablePaginatedAzureKeyVaultPushList {
	return &NullablePaginatedAzureKeyVaultPushList{value: val, isSet: true}
}

func (v NullablePaginatedAzureKeyVaultPushList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedAzureKeyVaultPushList) UnmarshalJSON(src []byte) error {
	v.isSet = true
