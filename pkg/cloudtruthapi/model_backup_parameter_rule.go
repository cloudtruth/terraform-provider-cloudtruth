...
type _BackupParameterRule BackupParameterRule
...
func (o *BackupParameterRule) UnmarshalJSON(bytes []byte) (err error) {
	...
	varBackupParameterRule := _BackupParameterRule{}

	err = json.Unmarshal(bytes, &varBackupParameterRule)

	if err != nil {
		return err
	}

	*o = BackupParameterRule(varBackupParameterRule)
