...
// checks if the AwsPullLatestTask type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsPullLatestTask{}

// AwsPullLatestTask The most recent task run for this action.
type AwsPullLatestTask struct {
	Url string `json:"url"`
...
type _AwsPullLatestTask AwsPullLatestTask
...
func (o AwsPullLatestTask) MarshalJSON() ([]byte, error) {
...
func (o AwsPullLatestTask) ToMap() (map[string]interface{}, error) {
...
func (o *AwsPullLatestTask) UnmarshalJSON(bytes []byte) (err error) {
	...
	varAwsPullLatestTask := _AwsPullLatestTask{}

	err = json.Unmarshal(bytes, &varAwsPullLatestTask)

	if err != nil {
		return err
	}

	*o = AwsPullLatestTask(varAwsPullLatestTask)

	return err
}

type NullableAwsPullLatestTask struct {
	value *AwsPullLatestTask
	isSet bool
}

func (v NullableAwsPullLatestTask) Get() *AwsPullLatestTask {
	return v.value
}

func (v *NullableAwsPullLatestTask) Set(val *AwsPullLatestTask) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsPullLatestTask) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsPullLatestTask) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsPullLatestTask(val *AwsPullLatestTask) *NullableAwsPullLatestTask {
	return &NullableAwsPullLatestTask{value: val, isSet: true}
}

func (v NullableAwsPullLatestTask) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsPullLatestTask) UnmarshalJSON(src []byte) error {
	v.isSet = true
