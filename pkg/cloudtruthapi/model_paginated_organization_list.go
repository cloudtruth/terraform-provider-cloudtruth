...
// checks if the PaginatedOrganizationList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedOrganizationList{}
...
func NewPaginatedOrganizationList() *PaginatedOrganizationList {
	this := PaginatedOrganizationList{}
	return &this
}
...
func (o PaginatedOrganizationList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedOrganizationList) ToMap() (map[string]interface{}, error) {
...
type NullablePaginatedOrganizationList struct {
	value *PaginatedOrganizationList
	isSet bool
}

func (v NullablePaginatedOrganizationList) Get() *PaginatedOrganizationList {
	return v.value
}

func (v *NullablePaginatedOrganizationList) Set(val *PaginatedOrganizationList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedOrganizationList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedOrganizationList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedOrganizationList(val *PaginatedOrganizationList) *NullablePaginatedOrganizationList {
	return &NullablePaginatedOrganizationList{value: val, isSet: true}
}

func (v NullablePaginatedOrganizationList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedOrganizationList) UnmarshalJSON(src []byte) error {
	v.isSet = true
