...
type _ParameterExport ParameterExport
...
func (o *ParameterExport) UnmarshalJSON(bytes []byte) (err error) {
	...
	varParameterExport := _ParameterExport{}

	err = json.Unmarshal(bytes, &varParameterExport)

	if err != nil {
		return err
	}

	*o = ParameterExport(varParameterExport)
