...
// PatchedServiceAccountUser struct for PatchedServiceAccountUser
type PatchedServiceAccountUser struct {
	Url string `json:"url"`
...
func NewPatchedServiceAccountUser(url string, id string, name NullableString, organizationName NullableString, membershipId NullableString, role NullableString, email NullableString, pictureUrl NullableString, createdAt time.Time, modifiedAt time.Time) *PatchedServiceAccountUser {
	this := PatchedServiceAccountUser{}
	this.Url = url
	this.Id = id
	this.Name = name
...
func (o PatchedServiceAccountUser) MarshalJSON() ([]byte, error) {
...
type NullablePatchedServiceAccountUser struct {
	value *PatchedServiceAccountUser
	isSet bool
}

func (v NullablePatchedServiceAccountUser) Get() *PatchedServiceAccountUser {
	return v.value
}

func (v *NullablePatchedServiceAccountUser) Set(val *PatchedServiceAccountUser) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedServiceAccountUser) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedServiceAccountUser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedServiceAccountUser(val *PatchedServiceAccountUser) *NullablePatchedServiceAccountUser {
	return &NullablePatchedServiceAccountUser{value: val, isSet: true}
}

func (v NullablePatchedServiceAccountUser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedServiceAccountUser) UnmarshalJSON(src []byte) error {
	v.isSet = true
