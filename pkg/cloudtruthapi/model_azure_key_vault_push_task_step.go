...
type _AzureKeyVaultPushTaskStep AzureKeyVaultPushTaskStep
...
func (o *AzureKeyVaultPushTaskStep) UnmarshalJSON(bytes []byte) (err error) {
	...
	varAzureKeyVaultPushTaskStep := _AzureKeyVaultPushTaskStep{}

	err = json.Unmarshal(bytes, &varAzureKeyVaultPushTaskStep)

	if err != nil {
		return err
	}

	*o = AzureKeyVaultPushTaskStep(varAzureKeyVaultPushTaskStep)
