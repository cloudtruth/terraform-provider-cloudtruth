...
// checks if the PaginatedValueList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedValueList{}
...
func (o PaginatedValueList) ToMap() (map[string]interface{}, error) {
