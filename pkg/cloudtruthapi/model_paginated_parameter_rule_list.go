...
// checks if the PaginatedParameterRuleList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedParameterRuleList{}
...
func NewPaginatedParameterRuleList() *PaginatedParameterRuleList {
	this := PaginatedParameterRuleList{}
	return &this
}
...
// SetResults gets a reference to the given []ParameterRule and assigns it to the Results field.
func (o *PaginatedParameterRuleList) SetResults(v []ParameterRule) {
	o.Results = v
}

func (o PaginatedParameterRuleList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedParameterRuleList) ToMap() (map[string]interface{}, error) {
...
type NullablePaginatedParameterRuleList struct {
	value *PaginatedParameterRuleList
	isSet bool
}

func (v NullablePaginatedParameterRuleList) Get() *PaginatedParameterRuleList {
	return v.value
}

func (v *NullablePaginatedParameterRuleList) Set(val *PaginatedParameterRuleList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedParameterRuleList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedParameterRuleList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedParameterRuleList(val *PaginatedParameterRuleList) *NullablePaginatedParameterRuleList {
	return &NullablePaginatedParameterRuleList{value: val, isSet: true}
}

func (v NullablePaginatedParameterRuleList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedParameterRuleList) UnmarshalJSON(src []byte) error {
	v.isSet = true
