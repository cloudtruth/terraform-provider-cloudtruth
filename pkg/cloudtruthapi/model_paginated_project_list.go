...
// checks if the PaginatedProjectList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedProjectList{}
...
func (o PaginatedProjectList) ToMap() (map[string]interface{}, error) {
