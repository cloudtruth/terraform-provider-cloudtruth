...
// checks if the PaginatedParameterDualityList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedParameterDualityList{}
...
func (o PaginatedParameterDualityList) ToMap() (map[string]interface{}, error) {
