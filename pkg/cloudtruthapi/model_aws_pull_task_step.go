...
// checks if the AwsPullTaskStep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsPullTaskStep{}

// AwsPullTaskStep Pull task step for an AWS integration.
type AwsPullTaskStep struct {
	Url string `json:"url"`
...
type _AwsPullTaskStep AwsPullTaskStep
...
func (o *AwsPullTaskStep) SetOperationNil() {
	o.Operation.Set(nil)
}
...
func (o *AwsPullTaskStep) SetSuccessDetailNil() {
...
func (o *AwsPullTaskStep) SetFqnNil() {
	o.Fqn.Set(nil)
}
...
func (o *AwsPullTaskStep) SetEnvironmentIdNil() {
...
func (o *AwsPullTaskStep) SetEnvironmentNameNil() {
...
func (o *AwsPullTaskStep) SetProjectIdNil() {
	o.ProjectId.Set(nil)
}
...
func (o *AwsPullTaskStep) SetProjectNameNil() {
...
func (o *AwsPullTaskStep) SetParameterIdNil() {
...
func (o *AwsPullTaskStep) SetParameterNameNil() {
...
func (o *AwsPullTaskStep) SetVenueIdNil() {
	o.VenueId.Set(nil)
}
...
func (o *AwsPullTaskStep) SetVenueNameNil() {
	o.VenueName.Set(nil)
}
...
func (o *AwsPullTaskStep) SetSummaryNil() {
	o.Summary.Set(nil)
}
...
func (o *AwsPullTaskStep) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *AwsPullTaskStep) SetErrorDetailNil() {
...
func (o AwsPullTaskStep) MarshalJSON() ([]byte, error) {
...
func (o AwsPullTaskStep) ToMap() (map[string]interface{}, error) {
...
func (o *AwsPullTaskStep) UnmarshalJSON(bytes []byte) (err error) {
	...
	varAwsPullTaskStep := _AwsPullTaskStep{}

	err = json.Unmarshal(bytes, &varAwsPullTaskStep)

	if err != nil {
		return err
	}

	*o = AwsPullTaskStep(varAwsPullTaskStep)

	return err
}

type NullableAwsPullTaskStep struct {
	value *AwsPullTaskStep
	isSet bool
}

func (v NullableAwsPullTaskStep) Get() *AwsPullTaskStep {
	return v.value
}

func (v *NullableAwsPullTaskStep) Set(val *AwsPullTaskStep) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsPullTaskStep) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsPullTaskStep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsPullTaskStep(val *AwsPullTaskStep) *NullableAwsPullTaskStep {
	return &NullableAwsPullTaskStep{value: val, isSet: true}
}

func (v NullableAwsPullTaskStep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsPullTaskStep) UnmarshalJSON(src []byte) error {
	v.isSet = true
