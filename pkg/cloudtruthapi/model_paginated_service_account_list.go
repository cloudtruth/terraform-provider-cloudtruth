...
// checks if the PaginatedServiceAccountList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedServiceAccountList{}

// PaginatedServiceAccountList struct for PaginatedServiceAccountList
type PaginatedServiceAccountList struct {
	Count *int32 `json:"count,omitempty"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results []ServiceAccount `json:"results,omitempty"`
}
...
func NewPaginatedServiceAccountList() *PaginatedServiceAccountList {
	this := PaginatedServiceAccountList{}
	return &this
}
...
func (o *PaginatedServiceAccountList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedServiceAccountList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []ServiceAccount and assigns it to the Results field.
func (o *PaginatedServiceAccountList) SetResults(v []ServiceAccount) {
	o.Results = v
}

func (o PaginatedServiceAccountList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedServiceAccountList) ToMap() (map[string]interface{}, error) {
...
type NullablePaginatedServiceAccountList struct {
	value *PaginatedServiceAccountList
	isSet bool
}

func (v NullablePaginatedServiceAccountList) Get() *PaginatedServiceAccountList {
	return v.value
}

func (v *NullablePaginatedServiceAccountList) Set(val *PaginatedServiceAccountList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedServiceAccountList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedServiceAccountList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedServiceAccountList(val *PaginatedServiceAccountList) *NullablePaginatedServiceAccountList {
	return &NullablePaginatedServiceAccountList{value: val, isSet: true}
}

func (v NullablePaginatedServiceAccountList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedServiceAccountList) UnmarshalJSON(src []byte) error {
	v.isSet = true
