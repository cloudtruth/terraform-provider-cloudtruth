...
type _ParameterUpdate ParameterUpdate
...
func (o *ParameterUpdate) UnmarshalJSON(bytes []byte) (err error) {
	...
	varParameterUpdate := _ParameterUpdate{}

	err = json.Unmarshal(bytes, &varParameterUpdate)

	if err != nil {
		return err
	}

	*o = ParameterUpdate(varParameterUpdate)
