...
// checks if the PaginatedGitHubPullList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedGitHubPullList{}
...
// SetResults gets a reference to the given []GitHubPull and assigns it to the Results field.
...
func (o PaginatedGitHubPullList) ToMap() (map[string]interface{}, error) {
...
type NullablePaginatedGitHubPullList struct {
	value *PaginatedGitHubPullList
	isSet bool
}

func (v NullablePaginatedGitHubPullList) Get() *PaginatedGitHubPullList {
	return v.value
}

func (v *NullablePaginatedGitHubPullList) Set(val *PaginatedGitHubPullList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedGitHubPullList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedGitHubPullList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedGitHubPullList(val *PaginatedGitHubPullList) *NullablePaginatedGitHubPullList {
	return &NullablePaginatedGitHubPullList{value: val, isSet: true}
}

func (v NullablePaginatedGitHubPullList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedGitHubPullList) UnmarshalJSON(src []byte) error {
	v.isSet = true
