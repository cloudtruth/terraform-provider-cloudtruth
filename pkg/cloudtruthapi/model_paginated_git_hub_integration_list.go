...
// checks if the PaginatedGitHubIntegrationList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedGitHubIntegrationList{}
...
func (o PaginatedGitHubIntegrationList) ToMap() (map[string]interface{}, error) {
