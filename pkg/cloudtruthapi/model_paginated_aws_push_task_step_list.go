...
// checks if the PaginatedAwsPushTaskStepList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedAwsPushTaskStepList{}
...
func (o PaginatedAwsPushTaskStepList) ToMap() (map[string]interface{}, error) {
