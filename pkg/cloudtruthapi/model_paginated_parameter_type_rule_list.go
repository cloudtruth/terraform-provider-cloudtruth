...
// checks if the PaginatedParameterTypeRuleList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedParameterTypeRuleList{}
...
func (o PaginatedParameterTypeRuleList) ToMap() (map[string]interface{}, error) {
