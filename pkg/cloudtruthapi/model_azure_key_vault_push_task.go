...
// checks if the AzureKeyVaultPushTask type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AzureKeyVaultPushTask{}

// AzureKeyVaultPushTask Push task for an Azure Key Vault integration.
type AzureKeyVaultPushTask struct {
	Url string `json:"url"`
...
type _AzureKeyVaultPushTask AzureKeyVaultPushTask
...
func (o *AzureKeyVaultPushTask) SetReasonNil() {
	o.Reason.Set(nil)
}
...
func (o *AzureKeyVaultPushTask) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *AzureKeyVaultPushTask) SetErrorDetailNil() {
...
func (o AzureKeyVaultPushTask) MarshalJSON() ([]byte, error) {
...
func (o AzureKeyVaultPushTask) ToMap() (map[string]interface{}, error) {
...
func (o *AzureKeyVaultPushTask) UnmarshalJSON(bytes []byte) (err error) {
	...
	varAzureKeyVaultPushTask := _AzureKeyVaultPushTask{}

	err = json.Unmarshal(bytes, &varAzureKeyVaultPushTask)

	if err != nil {
		return err
	}

	*o = AzureKeyVaultPushTask(varAzureKeyVaultPushTask)

	return err
}

type NullableAzureKeyVaultPushTask struct {
	value *AzureKeyVaultPushTask
	isSet bool
}

func (v NullableAzureKeyVaultPushTask) Get() *AzureKeyVaultPushTask {
	return v.value
}

func (v *NullableAzureKeyVaultPushTask) Set(val *AzureKeyVaultPushTask) {
	v.value = val
	v.isSet = true
}

func (v NullableAzureKeyVaultPushTask) IsSet() bool {
	return v.isSet
}

func (v *NullableAzureKeyVaultPushTask) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAzureKeyVaultPushTask(val *AzureKeyVaultPushTask) *NullableAzureKeyVaultPushTask {
	return &NullableAzureKeyVaultPushTask{value: val, isSet: true}
}

func (v NullableAzureKeyVaultPushTask) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAzureKeyVaultPushTask) UnmarshalJSON(src []byte) error {
	v.isSet = true
