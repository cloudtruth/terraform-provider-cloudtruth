...
// checks if the PaginatedAuditTrailList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedAuditTrailList{}
...
func (o PaginatedAuditTrailList) ToMap() (map[string]interface{}, error) {
