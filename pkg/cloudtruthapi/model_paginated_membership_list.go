...
// checks if the PaginatedMembershipList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedMembershipList{}

// PaginatedMembershipList struct for PaginatedMembershipList
...
func (o *PaginatedMembershipList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedMembershipList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o PaginatedMembershipList) ToMap() (map[string]interface{}, error) {
...
type NullablePaginatedMembershipList struct {
	value *PaginatedMembershipList
	isSet bool
}

func (v NullablePaginatedMembershipList) Get() *PaginatedMembershipList {
	return v.value
}

func (v *NullablePaginatedMembershipList) Set(val *PaginatedMembershipList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedMembershipList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedMembershipList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedMembershipList(val *PaginatedMembershipList) *NullablePaginatedMembershipList {
	return &NullablePaginatedMembershipList{value: val, isSet: true}
}

func (v NullablePaginatedMembershipList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedMembershipList) UnmarshalJSON(src []byte) error {
	v.isSet = true
